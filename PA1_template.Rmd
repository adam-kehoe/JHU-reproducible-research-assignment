...
The number of missing observations is `r missing_count`. The mean and median of the imputed data are `r imputed_steps_mean` and `r imputed_steps_median`, respectively.
